...
## Overview
Support Ticket is a simple single page web React application (and an ASP.Net Core counterpart) which allows you to capture support tickets into a database. You can add, view and edit tickets. 
